...
import SiteSketch from '../../../public/site_animation_mobile.svg';
import { gsap } from 'gsap';
import { HStack, Stack, Text } from '@chakra-ui/react';
import { ArrowUp, BarChart, Heart } from 'react-feather';

export function SiteAnimationMobile(){
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            gsap.to(".site_animation_mobile_svg__loader", { 
                repeat: -1,
                rotate: 360,
              ...
              function updateProgressBar(){
                gsap.set(".site_animation_mobile_svg__load_bar", {scaleX:timeline.progress(), transformOrigin:"0px 0px"});
              }
              
              timeline
              .set(".site_animation_mobile_svg__trace", { 
                y: 500
              })
              .fromTo(".site_animation_mobile_svg__site_sketch", { 
                y: 500
              }, {
                y: 0,
                duration: 1.2
              })
              .fromTo(".site_animation_mobile_svg__load_bar_black", { 
                y: 500
              }, {
                y: 0,
                duration: 1.2
              }, "<")
              .fromTo(".site_animation_mobile_svg__logo", { 
                autoAlpha: 0
              }, {
                autoAlpha: 1
              })
              .fromTo(".site_animation_mobile_svg__loader", { 
                autoAlpha: 0
              }, {
                autoAlpha: 1
              })
