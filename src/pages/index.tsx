  ...
  return (
    <Box pos="relative">
        ...
        <Flex flexDir="column" w="100%" bg="#2D2E36">
            <Flex bg="url(./background_fade.png)" backgroundSize="100%" backgroundRepeat={"no-repeat"} backgroundPosition="0 -90px">
                <Header/>

                <Flex bg="rgb(8,5,16,0.7)" w="100%">
                    <Stack px="6" w="100%" maxW="1200px" m="0 auto" py="36" spacing="16">
                        <HStack>
                        ...
                        <Stack pt="48" spacing="20">
                            ...
                            <HStack w="75%" spacing="0" alignItems={"baseline"} height="100%">
